...
// NewLoggingConfig creates a new logging configuration using the global feature gate singleton.
...
// The feature-gates flag is handled separately by FeatureGateConfig.
